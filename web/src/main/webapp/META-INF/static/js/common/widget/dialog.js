...
(function(ns, $) {
	...
	ns.Dialog.count = 0;
	ns.Dialog.event = ['onOpenBefore','onOpen','onClose','onHide','onResize'];
	ns.Dialog.prototype = {
		_closed:false,
		_count:null,
	...
	ns.alert = function(cfg){
		var icon = {
			INFO:'pub-icon-info pub-info48',
			WARN:'pub-icon-info pub-failed48',
			ERROR:'pub-icon-info pub-prob48',
			SUCC:'pub-icon-info pub-success48',
			HELP:'pub-icon-info pub-help48'
		};
		...
		var default_cfg = {
			...
			content:'<div class="lt-dialog-msg"><div class="l"><i class="'+icon[cfg.type]+'"></i></div><div class="info">'+cfg.content+'</div><div class="c"></div></div>\
					<div class="lt-dialog-opt ar">\
						<a class="pub-btns-s" href="javascript:closeAlert" rel="close"><span class="inner">'+cfg.label+'</span></a>\
					</div>',
			mask:false,
			type:'WARN'
		};
...
//			HELP:'lt-t-help48'
		...
		var default_cfg = {
			...
			content:'<div class="lt-dialog-msg"><div class="l"><i class="'+icon[cfg.type]+'"></i></div><div class="info">'+cfg.content+'</div><div class="c"></div></div>\
					<div class="lt-dialog-opt ar">\
						<a class="pub-btns-s" href="javascript:;" rel="confirm"><span class="inner">'+cfg.labelConfirm+'</span></a>&nbsp;\
						<a class="pub-btns-s" href="javascript:;" rel="cancel"><span class="inner">'+cfg.labelCancel+'</span></a>\
					</div>'
		};
		delete cfg.content;
		$.extend(default_cfg,cfg);
