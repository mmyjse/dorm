 ...
 * 密码MD5工具类
 * 
 * @author J 2013-4-2 下午4:05:42
 */
public class CreateMD5 {

    private static final Logger log = LoggerFactory.getLogger(CreateMD5.class);
    ...
    public final static class WebmacroBase64 {
        ...
        /*
         * base64 decoding: turn 4*6 bits into 3*8 bits via the pattern: xx111111 xx112222 xx222233 xx333333 (xx: high
         * bits unused)
         */
